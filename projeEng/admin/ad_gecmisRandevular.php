...
$total_records = getTotalMeetingsSonlanan(); 
$total_pages = ceil($total_records / $limit); 

$sonuc = getAllMeetingsSonlanan($limit, $offset);
?>
...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center mb-3">Past Appointments</h1>
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th style="width: 120px;">Destination <Address></Address></th>
                        <th>Driver</th>
                        <th>Phone</th>
                        <th>Status</th>
                        <th>Transactions</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ad_deleteMeeting.php?id=<?php echo $meetings["id"]; ?>" class="btn btn-danger btn-sm">Sil</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
