...
if(isset( $_SESSION["username"])) {
    ...
    $total_records = getTotalMeetingKullaniciSonlandi($ad); 
    $total_pages = ceil($total_records / $limit); 
    
    $sonuc = getMeetingsByAdOnayliSonlandi($limit, $offset,$ad);
?>
...
<ul class="nav nav-tabs d-flex justify-content-center align-items-center mb-4">
  <li class="nav-item">
    <a class="nav-link " aria-current="page" href="randevugoruntuleKullanici.php">Active Appointments
</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="randevuGoruntuleKullaniciBekleyenRandevu.php"> Appointments Pending Approval</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="randevuGoruntuleKullaniciGecmis.php">My Past Appointments</a>
  </li>
    ...
    <div class="row">
        ...
        <h1 class="text-center mb-3">My Past Appointments</h1>
                ...
                <tbody>
                    ...
                    <td><?php echo $selectedMeetings["id"] ?></td>
                        ...
                        <td>
                            ...
                            <a href="puanla.php?id=<?php echo $selectedMeetings["id"] ?>" class="btn btn-dark btn-sm">Rate</a>
