...
<?php
 ...
 if (isset($_POST["login"])) {
     ...
     if ($control == false) {
         $sql = "SELECT id,adminUsername,adminPassword from admin where adminUsername=?";
                ...
                <div class="card-body p-3 p-md-4 p-xl-5">
                  <div class="row">
                    <div class="col-12">
                      ...
                      <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
                        ...
                        <h4 class="text-center"><i class="fa fa-taxi" aria-hidden="true"></i> Admin Login <i class="fa fa-taxi" aria-hidden="true"></i></h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center mt-5">
                        <a href="admin/ad_register.php" class="link-secondary text-decoration-none">New Admin register</a>
